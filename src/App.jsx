      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <h1 className="hero-title">
            We turn your brand into viral social media content that rides trends
            before they peak
          </h1>
          <p className="hero-subtitle">
            TrendIa uses cutting-edge AI to create engaging promotional videos
            that capture attention and drive conversions. Stay ahead of the
            curve with content that trends.
          </p>
      ...
      <section id="platform" className="platform-section">
        <div className="section-header">
          ...
          <p className="section-subtitle">
            Upload your assets and let AI create stunning promotional videos in
            minutes
          </p>
        </div>
                ...
                {product && (
                  <div className="file-preview">
                    ...
                    <div className="file-info">
                      ...
                      <div className="file-size">
                        {(product.size / 1024).toFixed(0)} KB
                      </div>
                    </div>
                  </div>
                )}
            ...
            <div className="progress-container">
              ...
              {workflowSteps && (
                <div className="workflow-steps">
                  <div
                    className={`workflow-step ${workflowSteps.script?.status === "completed" ? "completed" : workflowSteps.script?.status === "processing" ? "processing" : "pending"}`}
                  >
                  ...
                  <div
                    className={`workflow-step ${workflowSteps.clips?.status === "completed" ? "completed" : workflowSteps.clips?.status === "processing" ? "processing" : "pending"}`}
                  >
                    <div className="step-icon">
                  ...
                  <div
                    className={`workflow-step ${workflowSteps.concat?.status === "completed" ? "completed" : workflowSteps.concat?.status === "processing" ? "processing" : "pending"}`}
                  >
                    <div className="step-icon">
